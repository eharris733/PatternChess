 ...
 * that count as "done for today". Drives the dashboard daily-goal hook and the
 * come-back-tomorrow streak loop. Fixed for now; intended to become a
 * per-profile preference later.
 */
