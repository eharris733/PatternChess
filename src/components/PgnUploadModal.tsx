  ...
  const onStart = async () => {
    ...
    try {
      ...
      await Promise.all([
        ...
        // ['blunders'] is the shared prefix for due / dueTomorrow / stats; the
        // old ['dueBlunders'] key matched nothing, so the homework card and
        // dashboard never refreshed after an upload.
